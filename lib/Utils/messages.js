...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        var _r, _s, _t;
        const firstSection = Array.isArray(message.productList) ? message.productList[0] : null;
        const firstProduct = Array.isArray(firstSection === null || firstSection === void 0 ? void 0 : firstSection.products) ? firstSection.products[0] : null;
        m.listMessage = {
            title: message.title,
            ...
            productListInfo: {
                ...
                headerImage: {
                    productId: (_r = firstProduct === null || firstProduct === void 0 ? void 0 : firstProduct.productId) !== null && _r !== void 0 ? _r : '',
                    jpegThumbnail: (_t = (_s = message.thumbnail) === null || _s === void 0 ? void 0 : _s.jpegThumbnail) !== null && _t !== void 0 ? _t : null,
                },
                businessOwnerJid: message.businessOwnerJid || message.bizJid,
            },
    ...
    if ('cards' in message && !!message.cards && Array.isArray(message.cards)) {
        const slides = await Promise.all(message.cards.map(async (slide) => {
            var _a, _b, _c, _d;
            const buttons = Array.isArray(slide === null || slide === void 0 ? void 0 : slide.buttons) ? slide.buttons : [];
            let headerMedia = {};
            ...
            return {
                ...
                body: {
                    text: (_b = slide === null || slide === void 0 ? void 0 : slide.body) !== null && _b !== void 0 ? _b : '',
                },
                footer: {
                    text: (_c = slide === null || slide === void 0 ? void 0 : slide.footer) !== null && _c !== void 0 ? _c : '',
                },
                nativeFlowMessage: {
                    buttons,
                },
    ...
    if ('shop' in message && !!message.shop) {
        const shopData = typeof message.shop === 'object' && message.shop !== null
            ? message.shop
            : { surface: message.shop, id: message.id };
        const interactiveMessage = {
            shopStorefrontMessage: Types_1.WAProto.Message.InteractiveMessage.ShopMessage.fromObject({
                surface: shopData.surface,
                id: shopData.id || message.id
            })
        };
        if ('text' in message) {
            interactiveMessage.body = {
...
const getSenderLid = (message) => {
    ...
    const lid = (0, WABinary_1.isLidUser)(sender) ? sender : message.key.senderLid;
